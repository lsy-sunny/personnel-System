<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作年限" prop="gongzuonianxian">
          <el-input v-model="ruleForm.gongzuonianxian" 
              placeholder="工作年限" clearable  :readonly="ro.gongzuonianxian"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否毕业" prop="shifoubiye">
          <el-select v-model="ruleForm.shifoubiye" placeholder="请选择是否毕业">
            <el-option
                v-for="(item,index) in shifoubiyeOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否毕业" prop="shifoubiye">
	      <el-input v-model="ruleForm.shifoubiye"
                placeholder="是否毕业" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiwangxinzi = true;
          ...
          if(o=='shifoubiye'){
            this.ruleForm.shifoubiye = obj[o];
	    this.ro.shifoubiye = true;
            continue;
          }
          if(o=='biyeyuanxiao'){
      ...
      this.$http({
		...
		if(json.xingbie!=''&&json.xingbie){
          ...
          this.$message.error(data.msg);
            ...
            this.shifoubiyeOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springboot27ek2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
