<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="标准薪酬" prop="biaozhunxinchou">
          <el-input v-model="ruleForm.biaozhunxinchou" 
              placeholder="标准薪酬" clearable  :readonly="ro.biaozhunxinchou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="标准薪酬" prop="biaozhunxinchou">
              <el-input v-model="ruleForm.biaozhunxinchou" 
                placeholder="标准薪酬" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="其他薪酬" prop="qitaxinchou">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="其他薪酬"
                  v-model="ruleForm.qitaxinchou" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qitaxinchou" label="其他薪酬" prop="qitaxinchou">
                    <span>{{ruleForm.qitaxinchou}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuangongxingming = true;
          ...
          if(o=='biaozhunxinchou'){
            this.ruleForm.biaozhunxinchou = obj[o];
	    this.ro.biaozhunxinchou = true;
            continue;
          }
          if(o=='qitaxinchou'){
            this.ruleForm.qitaxinchou = obj[o];
	    this.ro.qitaxinchou = true;
            continue;
          }
          if(o=='riqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xinchou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xinchouCrossAddOrUpdateFlag = false;
                  this.parent.search();
