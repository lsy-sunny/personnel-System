    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="培训标准" prop="peixunbiaozhun">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="培训标准"
                  v-model="ruleForm.peixunbiaozhun" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.peixunbiaozhun" label="培训标准" prop="peixunbiaozhun">
                    <span>{{ruleForm.peixunbiaozhun}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="培训人员选拔制度" prop="peixunrenyuanxuanbazhidu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="培训人员选拔制度"
                  v-model="ruleForm.peixunrenyuanxuanbazhidu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.peixunrenyuanxuanbazhidu" label="培训人员选拔制度" prop="peixunrenyuanxuanbazhidu">
                    <span>{{ruleForm.peixunrenyuanxuanbazhidu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      ro:{
	peixunbiaoti : false,
	peixunbiaozhun : false,
	peixunrenyuanxuanbazhidu : false,
      },
      ruleForm: {
        peixunbiaoti: '',
        peixunbiaozhun: '',
        peixunrenyuanxuanbazhidu: '',
      },
      rules: {
          peixunbiaoti: [
          ],
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.peixunbiaoti = true;
          ...
          if(o=='peixunbiaozhun'){
            this.ruleForm.peixunbiaozhun = obj[o];
	    this.ro.peixunbiaozhun = true;
            continue;
          }
          if(o=='peixunrenyuanxuanbazhidu'){
            this.ruleForm.peixunrenyuanxuanbazhidu = obj[o];
	    this.ro.peixunrenyuanxuanbazhidu = true;
            continue;
          }
        }
      }
