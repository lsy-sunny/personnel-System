    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="工作任务" prop="gongzuorenwu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gongzuorenwu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongzuorenwu" label="工作任务" prop="gongzuorenwu">
                    <span v-html="ruleForm.gongzuorenwu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongzidaiyu = true;
          ...
          if(o=='gongzuorenwu'){
            this.ruleForm.gongzuorenwu = obj[o];
	    this.ro.gongzuorenwu = true;
            continue;
          }
          if(o=='tupian'){
	...
	this.ruleForm.zhiweiyaoqiu = this.ruleForm.zhiweiyaoqiu.replace(reg,'../../../springboot27ek2/upload');
	this.ruleForm.gongzidaiyu = this.ruleForm.gongzidaiyu.replace(reg,'../../../springboot27ek2/upload');
	this.ruleForm.gongzuorenwu = this.ruleForm.gongzuorenwu.replace(reg,'../../../springboot27ek2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
