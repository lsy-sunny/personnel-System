<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="面试地点" prop="mianshididian">
          <el-input v-model="ruleForm.mianshididian" 
              placeholder="面试地点" clearable  :readonly="ro.mianshididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="面试地点" prop="mianshididian">
              <el-input v-model="ruleForm.mianshididian" 
