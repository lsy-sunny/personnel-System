<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开始上班时间" prop="kaishishangbanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.kaishishangbanshijian" 
                type="datetime"
                placeholder="开始上班时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaishishangbanshijian" label="开始上班时间" prop="kaishishangbanshijian">
              <el-input v-model="ruleForm.kaishishangbanshijian" 
                placeholder="开始上班时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiwu = true;
          ...
          if(o=='kaishishangbanshijian'){
            this.ruleForm.kaishishangbanshijian = obj[o];
	    this.ro.kaishishangbanshijian = true;
            continue;
          }
          if(o=='beizhu'){
